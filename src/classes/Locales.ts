...
const EN: IapticLocale = {
  ...
  PurchaseError_E_STORE_BLOCKED: "The Play Store is blocked on this device.",
  ...
  IapticError_6777033: "The Play Store is blocked on this device",
...
const ES: IapticLocale = {
  ...
  PurchaseError_E_STORE_BLOCKED: "Play Store está bloqueado en este dispositivo.",
  ...
  IapticError_6777033: "Play Store está bloqueado en este dispositivo",
...
const FR: IapticLocale = {
  ...
  PurchaseError_E_STORE_BLOCKED: "Le Play Store est bloqué sur cet appareil.",
  ...
  IapticError_6777033: "Le Play Store est bloqué sur cet appareil",
...
const DE: IapticLocale = {
  ...
  PurchaseError_E_STORE_BLOCKED: "Der Play Store ist auf diesem Gerät blockiert.",
  ...
  IapticError_6777033: "Der Play Store ist auf diesem Gerät blockiert",
...
const JA: IapticLocale = {
  ...
  PurchaseError_E_STORE_BLOCKED: "このデバイスでPlayストアがブロックされています。",
  ...
  IapticError_6777033: "このデバイスでPlayストアがブロックされています",
...
const ZH: IapticLocale = {
  ...
  PurchaseError_E_STORE_BLOCKED: "此设备上的Play商店已被屏蔽。",
  ...
  IapticError_6777033: "此设备上的Play商店已被屏蔽",
...
const PT: IapticLocale = {
  ...
  PurchaseError_E_STORE_BLOCKED: "A Play Store está bloqueada neste dispositivo.",
  ...
  IapticError_6777033: "A Play Store está bloqueada neste dispositivo",
